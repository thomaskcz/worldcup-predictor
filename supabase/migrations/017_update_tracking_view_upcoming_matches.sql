-- Update user_prediction_tracking view to only consider upcoming matches
-- This ensures continuous_predictions_count is calculated only for upcoming matches
